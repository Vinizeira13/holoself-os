/**
 * SVG Icon components — replacing Unicode characters for cross-platform consistency
 */
...
export function IconVolume({ size }: IconProps = {}) {
  return (
    <svg {...getIconProps(size)}>
